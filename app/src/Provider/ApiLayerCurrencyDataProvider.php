...
{
    public const string LATEST_URL = 'https://api.apilayer.com/currency_data/live';
    public const string HISTORICAL_URL = 'https://api.apilayer.com/currency_data/historical';
    ...
    public function getRates(\DateTimeImmutable $date): GetRatesResult
    {
        ...
        if (!is_array($data) || (isset($data['success']) && !$data['success'])) {
            throw new \RuntimeException($data['error']['info'] ?? 'Failed to parse ApiLayer Currency Data response');
        }

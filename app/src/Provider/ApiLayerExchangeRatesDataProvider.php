 ...
 */
final readonly class ApiLayerExchangeRatesDataProvider extends AbstractProviderRate
{
    ...
    public function __construct(
        ...
        parent::__construct($httpClient, $logger, $id);

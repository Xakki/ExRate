 ...
 */
final readonly class CurrencyDataFeedProvider extends AbstractProviderRate
{
    ...
    public function getRatesByDate(\DateTimeImmutable $date): GetRatesResult
    {
        ...
        foreach ($data['currency'] as $item) {
            ...
            $code = substr($pair, 4);
            $rates[$code] = new RateData(BcMath::round((string) $item['value'], $this->currencyPrecision));

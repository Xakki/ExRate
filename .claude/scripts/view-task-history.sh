...
#
# Universal: derives PROJECT_NAME / CLAUDE_PROJECT_PATH from its own location
# (script lives at <repo>/.claude/scripts/view-task-history.sh).
#
# Usage:
#   scripts/view-task-history.sh <session-id>
#   scripts/view-task-history.sh <task-name>      # last matching auto-run
#   scripts/view-task-history.sh --list           # list recent auto-runs
set -uo pipefail

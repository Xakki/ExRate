...
- **Always log exceptions**: Select the log level based on the importance of the exception.
- **Modern PHP Features**:
...
## Use code
- Instead of DateTime::createFromFormat, use \App\Util\Date::createFromFormat
- Use currency code as constant from \App\Util\Currencies or \App\Util\CryptoCurrencies
- If detect any TODO from output or logs - investigate this problem and 
